...
class buildLib:
    ...
    def build(self):
        ...
        rects, landmarks = self.faceDetect.detect_face(im, 80)  # min face size is set to 80x80
        ...
        for pos in person_features:  # there r some exceptions here, but I'll just leave it as this to keep it simple
            ...
            feature = [np.mean(self.faceFeatureModel.get_features(person_imgs[pos]), axis=0).tolist()]
